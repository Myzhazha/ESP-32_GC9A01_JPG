 ...
 * 
 * 程序硬件介绍 esp32 nodemcu + LCD屏幕240×240（GC9A01）
 * 
 * 必读！！！
 * ---------------------------
 * 开发板要改成 ESP32 Wrovre Module （版本1.0.3及以下编译正常，最新版会报错）
 * 工具-Partition Scheme 这里改成 Huqe APP （3MB No OTA / 1MB SPIFFS）否则会报错内存不够
 * 
 * 
 * B站原作者视频及资料：
 * 视频：https://www.bilibili.com/video/BV1hy4y1W7NL
 * 资料：只在原作者的Q群里开源；QQ群号：531732157
 * 
 * 请自行修改WIFI信息和第79行代码的城市代码
 *             
 * *****************************************************************/
...
//---------------修改此处""内的信息--------------------
const char ssid[] = "K3";      //WIFI名称 修改这2个就可以了
